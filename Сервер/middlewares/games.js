...
module.exports = {
  ...
  checkIfCategoriesAvaliable: checkIfCategoriesAvaliable,
  checkIfUsersAreSafe: checkIfUsersAreSafe,
  checkIsGameExists: checkIsGameExists,
  checkIsVoteRequest: checkIsVoteRequest
};
