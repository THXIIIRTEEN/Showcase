...
module.exports = {
  sendAllCategories: sendAllCategories,
  sendCategoryCreated: sendCategoryCreated,
  sendCategoryById: sendCategoryById,
  sendCategoryUpdated: sendCategoryUpdated,
  sendCategoryDeleted: sendCategoryDeleted
};
